 ...
 * unit by running three ordered, individually-idempotent Activities: (a) resolve broker_target +
 * delete the recon schedule, (b) terminate the kill-switch workflow, (c) delete the {@code
 ...
 * that way — the recon schedule id is {@code recon-v2-t-<tenant>-s-<strategy>-<brokerTarget>}, the
