...
public class LiveRequiredGateBootstrapper implements ApplicationRunner {
  ...
  public LiveRequiredGateBootstrapper(StrategyRegistry registry, TenantRegistry tenantRegistry) {
  ...
  public void run(ApplicationArguments args) {
    LiveRequiredGateValidator.validate(registry, tenantRegistry);
    log.info("live required-gate invariant validated via the active strategy registry");
  }
}
