...
public interface RiskActivities {
   ...
   *
   * <p>Issue #317: {@code accountEquity} is the workflow-supplied net-liquidation equity dispatched
   * from the {@code broker-<broker_target>} {@code AccountSnapshotActivity} (mirroring how {@code
